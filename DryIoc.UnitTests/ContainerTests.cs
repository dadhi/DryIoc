...
namespace DryIoc.UnitTests
{
    ...
    public class ContainerTests
    {
        ...
        public void Register_once_for_default_service()
        {
            var container = new Container();
            container.Register<IService, Service>();
            container.Register<IService, AnotherService>(ifAlreadyRegistered: IfAlreadyRegistered.KeepDefault);
        ...
        public void Register_once_for_default_service_when_couple_of_defaults_were_already_registered()
        {
            ...
            container.Register<IService, DisposableService>(ifAlreadyRegistered: IfAlreadyRegistered.KeepDefault);
        ...
        public void Register_once_for_named_service()
        {
            var container = new Container();
            container.Register<IService, Service>(named: "a");
            container.Register<IService, AnotherService>(named: "a", ifAlreadyRegistered: IfAlreadyRegistered.KeepDefault);
