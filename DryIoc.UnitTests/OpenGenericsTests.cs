    ...
    public class OpenGenericsTests
    {
        ...
        public void Possible_to_select_constructor_for_open_generic_imlementation()
        {
            ...
            container.Register(typeof(LazyOne<>),
                with: Made.Of(t => t.GetConstructorOrNull(args: new[] { typeof(Func<>).MakeGenericType(t.GetGenericParamsAndArgs()) })));
        ...
        {
            var container = new Container();
            container.RegisterMany(new[] { typeof(IceCreamSource<>) }, reuse: Reuse.Singleton);
        ...
        public void Should_throw_if_generic_service_is_not_implemented_in_impl_type()
        {
            ...
            Assert.AreEqual(ex.Error, Error.IMPLEMENTATION_NOT_ASSIGNABLE_TO_SERVICE_TYPE);
        }
