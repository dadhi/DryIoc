...
namespace DryIoc.UnitTests
{
    ...
    public class TypeToolsTests
    {
        ...
        {
            var types = typeof(Fuzz<>.NestedClazz).GetImplementedTypes(ReflectionTools.IncludeImplementedType.SourceType)
        ...
        {
            var types = typeof(Fuzz<>.NestedClazz).GetImplementedTypes(ReflectionTools.IncludeImplementedType.ObjectType)
                .Select(t => t.GetGenericDefinitionOrNull() ?? t);
        ...
        {
            var types = typeof(Fuzz<>.NestedClazz).GetImplementedTypes(ReflectionTools.IncludeImplementedType.ObjectType | ReflectionTools.IncludeImplementedType.SourceType)
                .Select(t => t.GetGenericDefinitionOrNull() ?? t);
        ...
        {
            var types = typeof(A).GetImplementedTypes(ReflectionTools.IncludeImplementedType.ObjectType);
        ...
        {
            var types = typeof(B).GetImplementedTypes(ReflectionTools.IncludeImplementedType.ObjectType);
