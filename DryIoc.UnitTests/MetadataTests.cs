...
namespace DryIoc.UnitTests
{
    ...
    public class MetadataTests
    {
        ...
        {
            var container = new Container();
            container.RegisterPublicTypes(typeof(Service<>), setup: ServiceSetup.WithMetadata(3));
        ...
        {
            var container = new Container();
            container.RegisterPublicTypes(typeof(Service<>), setup: ServiceSetup.WithMetadata(3), named: "some");
