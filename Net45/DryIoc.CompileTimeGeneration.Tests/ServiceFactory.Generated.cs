...
*/
            ...
            DefaultResolutions = DefaultResolutions.AddOrUpdate(
                ...
                (state, r, scope) => r.Resolver.SingletonScope.GetOrAdd(86, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(99, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool()))));
