...
*/
        ...
        public override object ResolveGenerated(Type serviceType, IScope scope)
        {
        ...
        public override object ResolveGenerated(Type serviceType, object serviceKey, IScope scope)
        {
        ...
        public IEnumerable<KV> ResolveManyGenerated(Type serviceType)
        {
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken))
            {
                ...
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_3);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_4);
                yield return new KV("slow", (StatelessFactoryDelegate)Create_5);
                yield return new KV("fast", (StatelessFactoryDelegate)Create_6);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Blah, (StatelessFactoryDelegate)Create_7);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_8);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_16);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IServiceWithMetadata))
            {
                ...
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_20);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_21);
                yield return new KV("b", (StatelessFactoryDelegate)Create_22);
                yield return new KV("a", (StatelessFactoryDelegate)Create_23);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Duck))
            {
                ...
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_31);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_35);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple))
            {
                ...
                yield return new KV("apple", (StatelessFactoryDelegate)Create_38);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One))
            {
                yield return new KV("two", (StatelessFactoryDelegate)Create_39);
                yield return new KV("one", (StatelessFactoryDelegate)Create_40);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_41);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, (StatelessFactoryDelegate)Create_42);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_43);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_44);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IFooService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_47);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_48);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamed))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_52);
                yield return new KV("named", (StatelessFactoryDelegate)Create_53);
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IPrintToCode))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_61);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_63);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamedService))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_70);
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler))
            {
                yield return new KV("slow", (StatelessFactoryDelegate)Create_78);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_79);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_80);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_82);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IMultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_83);
                yield return new KV("j", (StatelessFactoryDelegate)Create_84);
                yield return new KV("i", (StatelessFactoryDelegate)Create_85);
            }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(100, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(114, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }
