...
Unable to resolve DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool
  ...
  in wrapper LambdaExpression {RequiredServiceType=DryIoc.MefAttributedModel.UnitTests.CUT.HomeUser}
Where CurrentScope=null
  and ResolutionScope=null
Found registrations:
  {13, {ID=108, ImplType=DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool, Reuse=SingletonReuse {Lifespan=1000}}}
...
Unable to resolve DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool as parameter "tool"
  ...
  in wrapper LambdaExpression {RequiredServiceType=DryIoc.MefAttributedModel.UnitTests.CUT.WithUnregisteredExternalEdependency}
Where CurrentScope=null
  and ResolutionScope=null
Found registrations:
  {13, {ID=108, ImplType=DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool, Reuse=SingletonReuse {Lifespan=1000}}}
...
Unable to resolve wrapper DryIoc.Meta<Lazy<DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool>, DryIoc.MefAttributedModel.UnitTests.CUT.MineMeta> {RequiredServiceType=DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool} as parameter "tool"
  ...
  in wrapper LambdaExpression {RequiredServiceType=DryIoc.MefAttributedModel.UnitTests.CUT.MyCode}.
Please register service or specify Rules.WithUnknownServiceResolver.
...
*/
        ...
        public IEnumerable<KV> ResolveManyGenerated(Type serviceType)
        {
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FastHandler))
            {
                yield return new KV("fast", (StatelessFactoryDelegate)Create_1);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_3);
                yield return new KV("slow", (StatelessFactoryDelegate)Create_4);
                yield return new KV("fast", (StatelessFactoryDelegate)Create_5);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Blah, (StatelessFactoryDelegate)Create_6);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_7);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_10);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, (StatelessFactoryDelegate)Create_11);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_12);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_13);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithFieldAndProperty))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_19);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_20);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.WithBothTheSameExports))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_21);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_24);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamedService))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_29);
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.PrintToCodeExample))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_33);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler))
            {
                yield return new KV("slow", (StatelessFactoryDelegate)Create_34);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IFooService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_37);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_38);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple))
            {
                ...
                yield return new KV("apple", (StatelessFactoryDelegate)Create_41);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.LazyDepClient))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_43);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_44);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IMultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_45);
                yield return new KV("j", (StatelessFactoryDelegate)Create_46);
                yield return new KV("i", (StatelessFactoryDelegate)Create_47);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IPrintToCode))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_50);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_52);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_53);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_54);
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Service))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_59);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One))
            {
                yield return new KV("two", (StatelessFactoryDelegate)Create_66);
                yield return new KV("one", (StatelessFactoryDelegate)Create_67);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamed))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_68);
                yield return new KV("named", (StatelessFactoryDelegate)Create_69);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_70);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_71);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_72);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_73);
                yield return new KV("orange", (StatelessFactoryDelegate)Create_74);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IServiceWithMetadata))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_75);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_76);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_77);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IAnotherDb))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_84);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_85);
                yield return new KV("b", (StatelessFactoryDelegate)Create_86);
                yield return new KV("a", (StatelessFactoryDelegate)Create_87);
            }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(8, () => new DryIoc.MefAttributedModel.UnitTests.CUT.Service());
        }

        internal static object Create_11(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(9, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService());
        }

        internal static object Create_12(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(10, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(12, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DbMan());
        }

        internal static object Create_15(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(16, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject1((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject)r.Scopes.SingletonScope.GetOrAdd(15, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject())));
        }

        internal static object Create_16(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(17, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.GetDuck());
        }

        internal static object Create_17(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(18, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Duck);
        }

        internal static object Create_18(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(19, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory());
        }

        internal static object Create_19(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(21, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithFieldAndProperty { Property = (DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService)r.Scopes.SingletonScope.GetOrAdd(20, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService()), Field = (DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService)r.Scopes.SingletonScope.GetOrAdd(20, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService()) });
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(22, () => new DryIoc.MefAttributedModel.UnitTests.CUT.WithBothTheSameExports());
        }

        internal static object Create_22(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(24, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject3((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject3)r.Scopes.SingletonScope.GetOrAdd(23, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject3())));
        }

        internal static object Create_23(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(25, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooHey());
        }

        internal static object Create_24(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(6, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(26, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooBlah());
        }

        internal static object Create_27(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(27, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Scopes.SingletonScope.GetOrAdd(1, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }

        internal static object Create_28(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(28, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne());
        }

        internal static object Create_29(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(29, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService());
        }

        internal static object Create_30(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(30, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedService());
        }

        internal static object Create_31(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(31, () => new DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory());
        }

        internal static object Create_32(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(32, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AppleFactory());
        }

        internal static object Create_33(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(33, () => new DryIoc.MefAttributedModel.UnitTests.CUT.PrintToCodeExample());
        }

        internal static object Create_34(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(4, () => new DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler());
        }

        internal static object Create_35(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(34, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ClientWithServiceAndPrimitiveProperty { Service = (DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Scopes.SingletonScope.GetOrAdd(9, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService()) });
        }

        internal static object Create_36(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(37, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DependentService(new DryIoc.MefAttributedModel.UnitTests.CUT.TransientService(), (DryIoc.MefAttributedModel.UnitTests.CUT.SingletonService)r.Scopes.SingletonScope.GetOrAdd(35, () => new DryIoc.MefAttributedModel.UnitTests.CUT.SingletonService()), new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOpenGenericService<string>(), (DryIoc.MefAttributedModel.UnitTests.CUT.OpenGenericServiceWithTwoParameters<bool, bool>)r.Scopes.SingletonScope.GetOrAdd(36, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OpenGenericServiceWithTwoParameters<bool, bool>())));
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(38, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithImportedCtorParameter((DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService)r.Scopes.SingletonScope.GetOrAdd(29, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService())));
        }

        internal static object Create_40(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(40, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Scopes.SingletonScope.GetOrAdd(39, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateApple());
        }

        internal static object Create_41(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(42, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Scopes.SingletonScope.GetOrAdd(41, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateApple());
        }

        internal static object Create_42(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(41, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(45, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject2((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject2)r.Scopes.SingletonScope.GetOrAdd(44, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject2())));
        }

        internal static object Create_49(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(47, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory)r.Scopes.SingletonScope.GetOrAdd(46, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory())).Create());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(46, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory());
        }

        internal static object Create_52(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(48, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.Chicken);
        }

        internal static object Create_53(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(49, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Chicken);
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(39, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory());
        }

        internal static object Create_61(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(54, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(55, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExport());
        }

        internal static object Create_64(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(56, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyClient((DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Scopes.SingletonScope.GetOrAdd(9, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService())));
        }

        internal static object Create_65(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(35, () => new DryIoc.MefAttributedModel.UnitTests.CUT.SingletonService());
        }

        internal static object Create_66(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(57, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(58, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory)r.Scopes.SingletonScope.GetOrAdd(19, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory())).Create());
        }

        internal static object Create_72(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(59, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Scopes.SingletonScope.GetOrAdd(39, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateOrange());
        }

        internal static object Create_73(IResolverContext r, IScope scope)
        {
            return ((DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory)r.Scopes.SingletonScope.GetOrAdd(54, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory())).Create();
        }

        internal static object Create_74(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(60, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Scopes.SingletonScope.GetOrAdd(41, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateOrange());
        }

        internal static object Create_75(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(61, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneServiceWithMetadata());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(64, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FactoryConsumer(new DryIoc.MefAttributedModel.UnitTests.CUT.IFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>[] { (DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>)r.Scopes.SingletonScope.GetOrAdd(62, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>(() => (DryIoc.MefAttributedModel.UnitTests.CUT.One)r.Scopes.SingletonScope.GetOrAdd(57, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One()))), (DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>)r.Scopes.SingletonScope.GetOrAdd(63, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>(() => (DryIoc.MefAttributedModel.UnitTests.CUT.One)r.Scopes.SingletonScope.GetOrAdd(57, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One()))) }));
        }

        internal static object Create_81(IResolverContext r, IScope scope)
        {
            return r.Scopes.SingletonScope.GetOrAdd(3, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler());
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(65, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExportBaseImpl());
        }
