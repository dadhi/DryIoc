...
*/
        ...
        public IEnumerable<KV> ResolveManyGenerated(Type serviceType)
        {
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne))
            {
                ...
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_2);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_4);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_5);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FastHandler))
            {
                yield return new KV("fast", (StatelessFactoryDelegate)Create_8);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_16);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_17);
                yield return new KV("b", (StatelessFactoryDelegate)Create_18);
                yield return new KV("a", (StatelessFactoryDelegate)Create_19);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.DbMan))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_20);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_24);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamed))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_26);
                yield return new KV("named", (StatelessFactoryDelegate)Create_27);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_28);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamedService))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_30);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_31);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_34);
                yield return new KV("apple", (StatelessFactoryDelegate)Create_35);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_37);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_38);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_39);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_40);
                yield return new KV("orange", (StatelessFactoryDelegate)Create_41);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IServiceWithMetadata))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_44);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_45);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_46);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler))
            {
                yield return new KV("slow", (StatelessFactoryDelegate)Create_49);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_54);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, (StatelessFactoryDelegate)Create_55);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_56);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_57);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_58);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IFooService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_60);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_61);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IMultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_63);
                yield return new KV("j", (StatelessFactoryDelegate)Create_64);
                yield return new KV("i", (StatelessFactoryDelegate)Create_65);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_66);
                yield return new KV("slow", (StatelessFactoryDelegate)Create_67);
                yield return new KV("fast", (StatelessFactoryDelegate)Create_68);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Blah, (StatelessFactoryDelegate)Create_69);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_70);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IPrintToCode))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_72);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_73);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject3))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_74);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_79);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One))
            {
                yield return new KV("two", (StatelessFactoryDelegate)Create_85);
                yield return new KV("one", (StatelessFactoryDelegate)Create_86);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.PrintToCodeExample))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_87);
            }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(93, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne());
        }

        internal static object Create_2(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(94, () => new DryIoc.MefAttributedModel.UnitTests.CUT.BothExportManyAndExport());
        }

        internal static object Create_3(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(106, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExport());
        }

        internal static object Create_4(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(86, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.Chicken);
        }

        internal static object Create_5(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(87, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Chicken);
        }

        internal static object Create_6(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(103, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooBlah());
        }

        internal static object Create_7(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(36, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DbMan());
        }

        internal static object Create_8(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(51, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FastHandler());
        }

        internal static object Create_9(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(84, () => new DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(92, () => new DryIoc.MefAttributedModel.UnitTests.CUT.WithBothTheSameExports());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(107, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExportBaseImpl());
        }

        internal static object Create_14(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(89, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyClient((DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Resolver.SingletonScope.GetOrAdd(90, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService())));
        }

        internal static object Create_15(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(71, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AppleFactory());
        }

        internal static object Create_16(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(99, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(110, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }

        internal static object Create_17(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(108, () => new DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(104, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooConsumer(new System.Lazy<DryIoc.MefAttributedModel.UnitTests.CUT.IFooService>(() => (DryIoc.MefAttributedModel.UnitTests.CUT.IFooService)((DryIoc.IResolver)r.Resolver).ResolveKeyed(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IFooService), (object)DryIoc.DefaultKey.Of(1), DryIoc.IfUnresolved.Throw, (System.Type)null, r.Resolver.GetOrCreateResolutionScope(ref scope, typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FooConsumer), (object)null)))));
        }

        internal static object Create_22(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(33, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithImportedCtorParameter((DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService)r.Resolver.SingletonScope.GetOrAdd(35, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService())));
        }

        internal static object Create_23(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(102, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooHey());
        }

        internal static object Create_24(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(53, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler());
        }

        internal static object Create_25(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(31, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithMultipleCostructorsAndOneImporting(new DryIoc.MefAttributedModel.UnitTests.CUT.TransientService()));
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(35, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherNamedService());
        }

        internal static object Create_31(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(34, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedService());
        }

        internal static object Create_32(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(74, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(76, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Resolver.SingletonScope.GetOrAdd(74, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateApple());
        }

        internal static object Create_35(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(79, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Resolver.SingletonScope.GetOrAdd(77, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateApple());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(91, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService());
        }

        internal static object Create_38(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(73, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory)r.Resolver.SingletonScope.GetOrAdd(72, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory())).Create());
        }

        internal static object Create_39(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(75, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Resolver.SingletonScope.GetOrAdd(74, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateOrange());
        }

        internal static object Create_40(IResolverContextProvider r, IScope scope)
        {
            return ((DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory)r.Resolver.SingletonScope.GetOrAdd(80, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory())).Create();
        }

        internal static object Create_41(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(78, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Resolver.SingletonScope.GetOrAdd(77, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateOrange());
        }

        internal static object Create_42(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(72, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(27, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneServiceWithMetadata());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(18, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService());
        }

        internal static object Create_54(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(17, () => new DryIoc.MefAttributedModel.UnitTests.CUT.Service());
        }

        internal static object Create_55(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(90, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(60, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler());
        }

        internal static object Create_59(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(45, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject1((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject)r.Resolver.SingletonScope.GetOrAdd(42, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject())));
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(100, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(110, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(48, () => new DryIoc.MefAttributedModel.UnitTests.CUT.PrintToCodeExample());
        }

        internal static object Create_73(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(80, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory());
        }

        internal static object Create_74(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(47, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject3((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject3)r.Resolver.SingletonScope.GetOrAdd(44, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject3())));
        }

        internal static object Create_75(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(85, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.GetDuck());
        }

        internal static object Create_76(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(88, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Duck);
        }

        internal static object Create_77(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(50, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ClientWithServiceAndPrimitiveProperty { Service = (DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Resolver.SingletonScope.GetOrAdd(90, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService()) });
        }

        internal static object Create_78(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(83, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory)r.Resolver.SingletonScope.GetOrAdd(82, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory())).Create());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(46, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ImportConditionObject2((DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject2)r.Resolver.SingletonScope.GetOrAdd(43, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExportConditionalObject2())));
        }

        internal static object Create_81(IResolverContextProvider r, IScope scope)
        {
            return r.Resolver.SingletonScope.GetOrAdd(82, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(32, () => new DryIoc.MefAttributedModel.UnitTests.CUT.SingleServiceWithMetadata());
        }
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(66, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One());
        }
