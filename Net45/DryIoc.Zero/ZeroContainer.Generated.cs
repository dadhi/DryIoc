...
Found registrations:
  {13, {ID=109, ImplType=DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool, Reuse=SingletonReuse {Lifespan=1000}}}
...
*/
        ...
        public IEnumerable<KV> ResolveManyGenerated(Type serviceType)
        {
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler))
            {
                yield return new KV("slow", (StatelessFactoryDelegate)Create_2);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamed))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_7);
                yield return new KV("named", (StatelessFactoryDelegate)Create_8);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_9);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_10);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_11);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_12);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_13);
                yield return new KV("orange", (StatelessFactoryDelegate)Create_14);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_17);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_20);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_21);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_22);
                yield return new KV("apple", (StatelessFactoryDelegate)Create_23);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SingleServiceWithMetadata))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_24);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_27);
                yield return new KV("slow", (StatelessFactoryDelegate)Create_28);
                yield return new KV("fast", (StatelessFactoryDelegate)Create_29);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Blah, (StatelessFactoryDelegate)Create_30);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_31);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_34);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.UseLazyEnumerable))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_37);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Duck))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_42);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_43);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService))
            {
                ...
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, (StatelessFactoryDelegate)Create_51);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_52);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_53);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IServiceWithMetadata))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_54);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_55);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_56);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IMultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_59);
                yield return new KV("j", (StatelessFactoryDelegate)Create_60);
                yield return new KV("i", (StatelessFactoryDelegate)Create_61);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IPrintToCode))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_65);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_68);
                yield return new KV("b", (StatelessFactoryDelegate)Create_69);
                yield return new KV("a", (StatelessFactoryDelegate)Create_70);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One))
            {
                yield return new KV("two", (StatelessFactoryDelegate)Create_71);
                yield return new KV("one", (StatelessFactoryDelegate)Create_72);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_74);
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_81);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamedService))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_82);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_83);
            }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(99, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Scopes.SingletonScope.GetOrAdd(109, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }
        ...
        {
            return r.Scopes.SingletonScope.GetOrAdd(100, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Scopes.SingletonScope.GetOrAdd(109, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }
