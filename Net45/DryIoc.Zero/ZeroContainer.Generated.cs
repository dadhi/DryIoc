...
*/
        ...
        public IEnumerable<KV> ResolveManyGenerated(Type serviceType)
        {
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_2);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_3);
                yield return new KV("apple", (StatelessFactoryDelegate)Create_4);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_5);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_6);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_7);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_8);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_9);
                yield return new KV("orange", (StatelessFactoryDelegate)Create_10);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FoohHandler))
            {
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_13);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ClientWithServiceAndPrimitiveProperty))
            {
                yield return new KV(null, (StatelessFactoryDelegate)Create_17);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_23);
                yield return new KV("slow", (StatelessFactoryDelegate)Create_24);
                yield return new KV("fast", (StatelessFactoryDelegate)Create_25);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Blah, (StatelessFactoryDelegate)Create_26);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.BlahFooh.Fooh, (StatelessFactoryDelegate)Create_27);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_28);
                yield return new KV("b", (StatelessFactoryDelegate)Create_29);
                yield return new KV("a", (StatelessFactoryDelegate)Create_30);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_31);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, (StatelessFactoryDelegate)Create_32);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_33);
                yield return new KV(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, (StatelessFactoryDelegate)Create_34);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.PrintToCodeExample))
            {
                yield return new KV(1, (StatelessFactoryDelegate)Create_35);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.SlowHandler))
            {
                yield return new KV("slow", (StatelessFactoryDelegate)Create_37);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IMultiExported))
            {
                yield return new KV("c", (StatelessFactoryDelegate)Create_39);
                yield return new KV("j", (StatelessFactoryDelegate)Create_40);
                yield return new KV("i", (StatelessFactoryDelegate)Create_41);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Duck))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_48);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_49);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_56);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One))
            {
                yield return new KV("two", (StatelessFactoryDelegate)Create_58);
                yield return new KV("one", (StatelessFactoryDelegate)Create_59);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IFooService))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_61);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_62);
            }

            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FastHandler))
            {
                yield return new KV("fast", (StatelessFactoryDelegate)Create_63);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_65);
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_66);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.TransactHandler))
            {
                yield return new KV("transact", (StatelessFactoryDelegate)Create_77);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IServiceWithMetadata))
            {
                yield return new KV(DefaultKey.Of(0), (StatelessFactoryDelegate)Create_79);
                yield return new KV(DefaultKey.Of(1), (StatelessFactoryDelegate)Create_80);
                yield return new KV(DefaultKey.Of(2), (StatelessFactoryDelegate)Create_81);
            }
            ...
            if (serviceType == typeof(DryIoc.MefAttributedModel.UnitTests.CUT.INamed))
            {
                yield return new KV("blah", (StatelessFactoryDelegate)Create_85);
                yield return new KV("named", (StatelessFactoryDelegate)Create_86);
        ...
        {
            return r.Resolver.SingletonScope.GetOrAdd(100, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(110, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool())));
        }
