...
*/
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FactoryConsumer), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(66, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FactoryConsumer(new DryIoc.MefAttributedModel.UnitTests.CUT.IFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>[] { (DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>)r.Resolver.SingletonScope.GetOrAdd(113, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>(() => (DryIoc.MefAttributedModel.UnitTests.CUT.One)r.Resolver.SingletonScope.GetOrAdd(67, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One()))), (DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>)r.Resolver.SingletonScope.GetOrAdd(114, () => new DryIoc.MefAttributedModel.UnitTests.CUT.DryFactory<DryIoc.MefAttributedModel.UnitTests.CUT.One>(() => (DryIoc.MefAttributedModel.UnitTests.CUT.One)r.Resolver.SingletonScope.GetOrAdd(67, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One()))) })));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult), 
                (r, scope) => new DryIoc.MefAttributedModel.UnitTests.CUT.LazyDecorator(
                    new System.Lazy<DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult>(() => 
                        (DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult)((DryIoc.IResolver)r.Resolver).ResolveKeyed(
                            typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult), (object)null, DryIoc.IfUnresolved.Throw, (System.Type)null, 
                            r.Resolver.GetOrCreateResolutionScope(ref scope, typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IDecoratedResult), (object)null)))));
...
*/
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported), "c", 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(109, () => new DryIoc.MefAttributedModel.UnitTests.CUT.MultiExported()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.BothExportManyAndExport), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(95, () => new DryIoc.MefAttributedModel.UnitTests.CUT.BothExportManyAndExport()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IOne), "blah", 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(94, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedOne()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(100, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OneDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(116, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool()))));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IForExport), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(107, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExport()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(85, () => new DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService), DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.One, 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(91, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.IService), DryIoc.MefAttributedModel.UnitTests.CUT.ServiceKey.OtherOne, 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(92, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherKeyService()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple), DefaultKey.Of(0), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(77, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Resolver.SingletonScope.GetOrAdd(75, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateApple()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Apple), "apple", 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(80, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Resolver.SingletonScope.GetOrAdd(78, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateApple()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.KeyClient), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(90, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyClient((DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Resolver.SingletonScope.GetOrAdd(91, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService()))));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange), DefaultKey.Of(0), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(74, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory)r.Resolver.SingletonScope.GetOrAdd(73, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory())).Create()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange), DefaultKey.Of(1), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(76, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory)r.Resolver.SingletonScope.GetOrAdd(75, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory())).CreateOrange()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange), DefaultKey.Of(2), 
                (r, scope) => ((DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory)r.Resolver.SingletonScope.GetOrAdd(81, () => new DryIoc.MefAttributedModel.UnitTests.CUT.TransientOrangeFactory())).Create());

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Orange), "orange", 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(79, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory)r.Resolver.SingletonScope.GetOrAdd(78, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory())).CreateOrange()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OtherDependsOnExternalTool), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(101, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OtherDependsOnExternalTool((DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool)r.Resolver.SingletonScope.GetOrAdd(116, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ExternalTool()))));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ForExportBase), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(108, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ForExportBaseImpl()));
            ...
            registrator.Register(typeof(System.Func<string, DryIoc.MefAttributedModel.UnitTests.CUT.Orange>), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(84, () => ((DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory)r.Resolver.SingletonScope.GetOrAdd(83, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory())).Create()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(83, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FuncFactory()));
...
*/
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Duck), DefaultKey.Of(0), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(86, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.GetDuck()));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Duck), DefaultKey.Of(1), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(89, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Duck));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FooHey), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(103, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooHey()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FooBlah), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(104, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FooBlah()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.WithBothTheSameExports), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(93, () => new DryIoc.MefAttributedModel.UnitTests.CUT.WithBothTheSameExports()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(75, () => new DryIoc.MefAttributedModel.UnitTests.CUT.FruitFactory()));
...
*/
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(73, () => new DryIoc.MefAttributedModel.UnitTests.CUT.OrangeFactory()));
...
*/
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ClientWithServiceAndPrimitiveProperty), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(51, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ClientWithServiceAndPrimitiveProperty { Service = (DryIoc.MefAttributedModel.UnitTests.CUT.KeyService)r.Resolver.SingletonScope.GetOrAdd(91, () => new DryIoc.MefAttributedModel.UnitTests.CUT.KeyService()) }));
...
*/
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.One), "two", 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(67, () => new DryIoc.MefAttributedModel.UnitTests.CUT.One()));
...
*/
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(78, () => new DryIoc.MefAttributedModel.UnitTests.CUT.NamedFruitFactory()));
            ...
            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithFieldAndProperty), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(99, () => new DryIoc.MefAttributedModel.UnitTests.CUT.ServiceWithFieldAndProperty { Property = (DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService)r.Resolver.SingletonScope.GetOrAdd(117, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService()), Field = (DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService)r.Resolver.SingletonScope.GetOrAdd(117, () => new DryIoc.MefAttributedModel.UnitTests.CUT.AnotherService()) }));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken), DefaultKey.Of(0), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(87, () => DryIoc.MefAttributedModel.UnitTests.CUT.BirdFactory.Chicken));

            registrator.Register(typeof(DryIoc.MefAttributedModel.UnitTests.CUT.Chicken), DefaultKey.Of(1), 
                (r, scope) => r.Resolver.SingletonScope.GetOrAdd(88, () => DryIoc.MefAttributedModel.UnitTests.CUT.StaticBirdFactory.Chicken));
