...
rem DryIoc
rem %NUGET% push "%PACKAGEDIR%\DryIoc.dll.3.0.0-preview-09.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.3.0.0-preview-09.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.Internal.3.0.0-preview-09.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIocZero
%NUGET% push "%PACKAGEDIR%\DryIocZero.4.0.0-preview-14.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
