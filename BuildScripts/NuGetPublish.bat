...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.10.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.10.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.10.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIocZero
%NUGET% push "%PACKAGEDIR%\DryIocZero.2.7.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
