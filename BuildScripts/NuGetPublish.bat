...
rem dotnet nuget push "%PACKAGES%\DryIoc.dll.4.0.2.nupkg" -k %APIKEY% -s %SOURCE%
rem dotnet nuget push "%PACKAGES%\DryIoc.4.0.2.nupkg" -k %APIKEY% -s %SOURCE%
rem dotnet nuget push "%PACKAGES%\DryIoc.Internal.4.0.2.nupkg" -k %APIKEY% -s %SOURCE%
