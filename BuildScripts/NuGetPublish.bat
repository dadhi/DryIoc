...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.12.0-preview-01.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.12.0-preview-01.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.12.0-preview-01.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIocZero
rem %NUGET% push "%PACKAGEDIR%\DryIocZero.3.0.0-preview-05.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem %NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.1.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.1.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
