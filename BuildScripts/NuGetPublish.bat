...
rem DryIoc
rem %NUGET% push "%PACKAGEDIR%\DryIoc.dll.3.0.0-preview-05.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.3.0.0-preview-05.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.Internal.3.0.0-preview-05.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIocZero
rem %NUGET% push "%PACKAGEDIR%\DryIocZero.4.0.0-preview-05.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.4.0.0-preview-03.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.4.0.0-preview-03.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
