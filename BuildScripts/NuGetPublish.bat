...
dotnet nuget push "%PACKAGES%\DryIoc.dll.4.1.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.4.1.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.Internal.4.1.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
