...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.10.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.10.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.10.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIoc.Web
%NUGET% push "%PACKAGEDIR%\DryIoc.Web.2.2.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Web.dll.2.2.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%

rem DryIoc.Mvc
%NUGET% push "%PACKAGEDIR%\DryIoc.Mvc.2.2.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Mvc.dll.2.2.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
