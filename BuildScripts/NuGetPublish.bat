...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.11.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.11.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.11.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem DryIocZero
rem %NUGET% push "%PACKAGEDIR%\DryIocZero.2.7.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%

rem DryIocAttributes
%NUGET% push "%PACKAGEDIR%\DryIocAttributes.3.0.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIocAttributes.dll.3.0.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%

rem DryIoc.MefAttributedModel
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.0.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.0.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
