...
rem DryIoc
rem %NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.9.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.2.9.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.9.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.0.0-preview-02.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.0.0-preview-02.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem %NUGET% push "%PACKAGEDIR%\DryIoc.WebApi.dll.2.1.1.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
