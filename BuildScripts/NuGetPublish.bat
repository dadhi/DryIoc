...
dotnet nuget push "%PACKAGES%\DryIoc.dll.4.0.5-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.4.0.5-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.Internal.4.0.5-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
