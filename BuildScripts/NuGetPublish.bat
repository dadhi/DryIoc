...
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.1.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.1.2.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
