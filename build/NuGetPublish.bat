...
@REM dotnet nuget push "%PACKAGES%\DryIoc.dll.6.0.0-preview-09.nupkg" -k %APIKEY% -s %SOURCE%
...
dotnet nuget push "%PACKAGES%\DryIoc.Microsoft.DependencyInjection.8.0.0-preview-04.nupkg" -k %APIKEY% -s %SOURCE%
...
@REM dotnet nuget push "%PACKAGES%\DryIocAttributes.dll.8.0.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
@REM rem dotnet nuget push "%PACKAGES%\DryIocAttributes.8.0.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%

@REM dotnet nuget push "%PACKAGES%\DryIoc.MefAttributedModel.dll.8.0.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
