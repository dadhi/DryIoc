...
dotnet nuget push "%PACKAGES%\DryIoc.dll.5.4.0.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.5.4.0.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.Internal.5.4.0.nupkg" -k %APIKEY% -s %SOURCE%

dotnet nuget push "%PACKAGES%\DryIoc.Microsoft.DependencyInjection.6.2.0.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.Microsoft.DependencyInjection.src.6.2.0.nupkg" -k %APIKEY% -s %SOURCE%
