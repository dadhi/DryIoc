...
dotnet nuget push "%PACKAGES%\DryIoc.dll.6.0.0-preview-06.nupkg" -k %APIKEY% -s %SOURCE%
@REM dotnet nuget push "%PACKAGES%\DryIoc.5.4.3.nupkg" -k %APIKEY% -s %SOURCE%
@REM dotnet nuget push "%PACKAGES%\DryIoc.Internal.5.4.3.nupkg" -k %APIKEY% -s %SOURCE%

dotnet nuget push "%PACKAGES%\DryIoc.Microsoft.DependencyInjection.8.0.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
