...
dotnet nuget push "%PACKAGES%\DryIoc.dll.5.3.1.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.5.3.1.nupkg" -k %APIKEY% -s %SOURCE%
dotnet nuget push "%PACKAGES%\DryIoc.Internal.5.3.1.nupkg" -k %APIKEY% -s %SOURCE%
