...
dotnet nuget push "%PACKAGES%\DryIoc.dll.5.4.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
@REM dotnet nuget push "%PACKAGES%\DryIoc.5.3.4.nupkg" -k %APIKEY% -s %SOURCE%
@REM dotnet nuget push "%PACKAGES%\DryIoc.Internal.5.3.4.nupkg" -k %APIKEY% -s %SOURCE%

dotnet nuget push "%PACKAGES%\DryIoc.Microsoft.DependencyInjection.6.2.0-preview-01.nupkg" -k %APIKEY% -s %SOURCE%
