...
namespace Playground
{
    public class ImMapBenchmarks
    {
        ...
        public class Populate
        {
            ...
            ## Moving `Height==0` case out. 

                     Method | Count |        Mean |       Error |      StdDev | Ratio | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
            --------------- |------ |------------:|------------:|------------:|------:|------------:|------------:|------------:|--------------------:|
                AddOrUpdate |     5 |    169.7 ns |   1.1245 ns |   0.9969 ns |  1.00 |      0.1321 |           - |           - |               624 B |
             AddOrUpdate_v2 |     5 |    189.9 ns |   0.7393 ns |   0.6553 ns |  1.12 |      0.1287 |           - |           - |               608 B |
             AddOrUpdate_v1 |     5 |    227.1 ns |   0.4555 ns |   0.4038 ns |  1.34 |      0.1729 |           - |           - |               816 B |
                            |       |             |             |             |       |             |             |             |                     |
                AddOrUpdate |    40 |  3,275.3 ns |   9.5985 ns |   8.0152 ns |  1.00 |      2.3575 |           - |           - |             11136 B |
             AddOrUpdate_v1 |    40 |  4,008.2 ns |   8.2581 ns |   6.8959 ns |  1.22 |      2.8915 |           - |           - |             13680 B |
             AddOrUpdate_v2 |    40 |  4,293.8 ns |   9.2146 ns |   8.6194 ns |  1.31 |      2.3499 |           - |           - |             11104 B |
                            |       |             |             |             |       |             |             |             |                     |
                AddOrUpdate |   200 | 23,532.6 ns |  57.7978 ns |  54.0641 ns |  1.00 |     16.6321 |           - |           - |             78624 B |
             AddOrUpdate_v1 |   200 | 27,777.8 ns |  68.5106 ns |  57.2095 ns |  1.18 |     19.5923 |      0.0305 |           - |             92592 B |
             AddOrUpdate_v2 |   200 | 31,193.1 ns | 203.6441 ns | 180.5252 ns |  1.33 |     16.6016 |      0.0610 |           - |             78592 B |
