...
namespace DryIoc.UnitTests
{
    ...
    public class AsyncExecutionFlowScopeContextTests : ITest
    {
        ...
        [Test]
        public async Task Scoped_service_should_Not_propagate_over_async_boundary_with_thread_context()
        {
        ...
        [Test]
        public async Task Given_thread_context_the_ScopedOrSingleton_service_may_be_resolved_outside_of_context()
        {
            using (var container = new Container(scopeContext: new ThreadScopeContext()))
            {
